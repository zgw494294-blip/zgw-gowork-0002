...
```bash
./build_benzhi_docker.sh zgw-gowork-0002:benzhi-amd64 linux/amd64
./build_benzhi_docker.sh zgw-gowork-0002:benzhi-arm64 linux/arm64
```

## 运行

```bash
docker run --rm -it --network none zgw-gowork-0002:benzhi-amd64 bash
```
